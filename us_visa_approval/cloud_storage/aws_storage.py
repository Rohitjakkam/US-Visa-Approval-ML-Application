...
class SimpleStorageService:
    ...
    @staticmethod
    def read_object(object_name: Union[str, List[str]], decode: bool = True, make_readable: bool = False) -> Union[StringIO, str]:
        """
        ...
        try:
            if isinstance(object_name, list):
                object_name = object_name[0]  # Assuming we want the first object if it's a list
